...
- `model.simulator`: simulates data under user-specified parameter values and covariates
...
```{r example3, messages=F, warning=F, results='hold', fig.show='hold'}
# plot PICmodel predictions and KM-curve to compare 
...
- update model predict functions to allow for model fits where the general intercept was not estimated. 
